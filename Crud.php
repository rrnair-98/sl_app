...
class Crud
{
    ...
    /*function which accepts table name and an aaray of*/
    function deleteData($table,array $del_array,$whereParam)   ids to delete
    {
        try
        {
...
function insert($table,array $columns,array $values)
{
    ...
    */
    ...
    "where $whereParam = $id*/
    function updateData($id,$table,array $columns,array $values,$whereParam)   updation
    {
        try
        {
            if(!$this->checkIfTableExists($table))
